  ...
  return (
    ...
    >
      <header className="flex flex-row-reverse justify-between sm:flex-row">
        ...
        >
          {loginScreenState === "LOGIN" ? "Cadastre-se" : "Entre"}
        </button>
      </header>
      <div className="flex grow items-center justify-center">
        <div className="flex w-full flex-col gap-5 sm:w-96">
          <h2 className="text-center text-2xl font-bold text-gray-800">
            {loginScreenState === "LOGIN" ? "Entrar" : "Crie seu perfil"}
          </h2>
          ...
          >
            {loginScreenState === "LOGIN" ? "Entrar" : "Criar perfil"}
          </button>
          <div className="flex items-center gap-2">
            <div className="h-[2px] grow bg-gray-300"></div>
            <span className="font-bold uppercase text-gray-400">ou</span>
            <div className="h-[2px] grow bg-gray-300"></div>
          </div>
